      ...
      {lineItems.map((line, index) => {
        ...
        return (
          <div className="lineRow" key={index}>
            ...
            <select value={line.variant} onChange={(e) => updateLine(index, "variant", e.target.value)} disabled={!line.itemId || variants.length === 0}>
            ...
            <input type="number" min="0" step="0.01" value={line.discountValue === "" ? "" : Number(line.discountValue)} onChange={(e) => handleDiscountChange(index, e.target.value)} onBlur={(e) => handleDiscountBlur(index, e.target.value)} inputMode="decimal" />
      ...
      <div className="actions">
        ...
        {createdInvoice?._id && (
          <>
            ...
            <a href={apiUrl(`/api/invoices/${createdInvoice._id}/pdf`)} download>
              Download
            </a>
          </>
        )}
